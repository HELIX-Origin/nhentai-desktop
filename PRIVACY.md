...
The nhentai desktop client ("the App") is built around one principle: **your data stays on your
...
- **All localStorage data** (favorites, history, blacklist, settings): clear it in the App's
...
- **Everything:** uninstall with **Remove user data** checked, or delete the App data folder
  (`%LOCALAPPDATA%\nhentai`, `~/Library/Application Support/nhentai`, `~/.local/share/nhentai`).
