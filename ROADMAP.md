...
- [x] Rust client returns real nhentai data (search, newest, detail) through Tauri commands
- [x] SPA chrome navigates between Home / Search / Favorites / History / Blacklist / Settings
- [x] Design tokens wired (dark theme live, light reserved); responsive grid
- [x] CSP hardened (image hosts allowlisted, IPC only, devCsp for Vite HMR)
